...
Falls back to a synthetic EngineData if no real .mpp fixture is available.
"""
...
# Fixture path — generated by scripts/create_test_fixture.py
...
@pytest.mark.skipif(
    ...
    reason=f"Test fixture not found: {FIXTURE_MPP}. Run scripts/create_test_fixture.py first.",
)
